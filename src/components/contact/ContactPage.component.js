    ...
    return (
      <div id="contact-page">
        ...
        <div className="container">
          ...
          <Subpage>
            <h1>Contact Us</h1>
            <p>Westwood Golf Club (formerly Duquesne Country Club), has been a golf enthusiasts haven for over 75 years!
              ...
              bar, large banquet hall. locker rooms, pro shop and championship style golf with challenging holes nestled
            ...
            <div className="row form-container">
              ...
              <div className="col-md-12">
                <div className="form-group form-group-lg">
                  ...
                  <textarea className="form-control message-body" placeholder="Your comments, please..."></textarea>
                </div>
              </div>
              <div className="col-md-12">
                <button className="btn btn-lg btn-gold pull-right">
